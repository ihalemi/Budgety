/* Budgetting App
    ...
    UI Module
    - get input values
    - add new expense item to the UI
...
var UIController = (function() {
    ...
    var formatNumber = function(num, type) {
        ...
        // + or - before number
        // two decimal points per number
        // comma seperating four digit numbers
        // 2310.4567 -> + 2,310.46
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function(e) {
        ...
        // retrieve item id with DOM traversing
        itemID = e.target.parentNode.parentNode.parentNode.parentNode.id;

        if(itemID) {
            // inc-1, inc-2 etc. - ['inc', '1'] 
